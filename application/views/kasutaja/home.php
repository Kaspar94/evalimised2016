	...
	<div id="body">
		...
		<?php
			...
			foreach($providers as $provider => $data) {
				if ($data['connected']) {
					echo "<li>".anchor('kasutaja/logout/'.$provider,'Logout of '.$provider, array('class' => 'connected'))."</li>";
				} else {
					echo "<li>".anchor('kasutaja/login/'.$provider,$provider, array('class' => 'login'))."</li>";
				}
			}
		?>
		</ul>
